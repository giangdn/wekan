...
Meteor.startup(() => {
  Notifications.subscribe('email', (user, title, description, params) => {
    ...
    Meteor.setTimeout(() => {
      ...
      const text = texts.join('</span></p><br><hr><br><p style=\'line-height: 18.0pt; mso-line-height-rule: exactly\'><span style=\'font-size: 12.0pt; font-family: Helvetica, sans-serif; color: #737F8D\'>');
